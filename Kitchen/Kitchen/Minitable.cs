...
namespace Kitchen
{
    public partial class Minitable : UserControl
    {
  ...
  //string myConnectionString = "server=localhost; uid=root; pwd=; database=menu";
        ...
        public void insert(string item0, string item1, string item2, string item3, string item4, string item5, string item6, string item7, string item8) {

            dataGridView1.Rows.Add(item0, item1, item2, item3, item4, item5, item6, item7, item8);
            mon.addcount(item2.Remove(item2.Length-1), item1);
        }
        ...
        public void loadGrid()
        {
            ...
            //                if (ds.Tables[0].Rows[x].ItemArray[6].ToString() == "Served") { }
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.ColumnIndex == 5) {
                mon.subcount(dataGridView1.CurrentRow.Cells[2].Value.ToString().Replace("*", ""), dataGridView1.CurrentRow.Cells[1].Value.ToString());
